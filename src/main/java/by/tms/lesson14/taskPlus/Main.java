...
public class Main {
    public static void main(String[] args) {
        ...
        // путь к файлу вводим в консоли ->  src/by.tms.lesson14/taskPlus/documents.txt

        Validator validator = new Validator();
        validator.scan();
        StringBuilder bufferDocuments = validator.reader();
        validator.validation(bufferDocuments);
